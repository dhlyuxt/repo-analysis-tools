...
The repository currently distributes one workflow skill. It is mirrored in both [`.agents/skills`](./.agents/skills) and [`.claude/skills`](./.claude/skills) so the same guidance can be used from different clients.
