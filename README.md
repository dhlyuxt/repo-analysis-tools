...
The repository currently mirrors four skill packages across [`.agents/skills`](./.agents/skills) and [`.claude/skills`](./.claude/skills). Only `repo-understand` is the active workflow skill for repository understanding; the other mirrored skills are supporting analysis skills.
